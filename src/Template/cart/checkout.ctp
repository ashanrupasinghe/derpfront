            ...
            else
            {
                document.getElementById('text1').style.display = "";
                    ...
                    <div class="buttons-set" id="billing-buttons-container">
                      ...
                      <span class="please-wait" id="billing-please-wait" style="display:none;"> <?php echo $this->Html->image('opc-ajax-loader.gif',['alt'=>'Loading next step...','title'=>'Loading next step...','class'=>'v-middle']); ?> Loading next step... </span> </div>
                  </fieldset>
                </form>
              ...
              <div id="checkout-step-shipping" class="step a-item" style="display:none;">
                <form action="" id="co-shipping-form">
                  ...
                  <div class="buttons-set" id="shipping-buttons-container">
                    ...
                    <a href="#" onClick="checkout.back(); return false;" class="back" ><small>« </small>Back</a> <span id="shipping-please-wait" class="please-wait" style="display:none;"> <?php echo $this->Html->image('opc-ajax-loader.gif',['alt'=>'Loading next step...','title'=>'Loading next step...','class'=>'v-middle']); ?> Loading next step... </span> </div>
                </form>
              ...
              <div id="checkout-step-shipping_method" class="step a-item" style="display:none;">
                <form id="co-shipping-method-form" action="">
                  ...
                  <div class="buttons-set" id="shipping-method-buttons-container">
                    ...
                    <a href="#" onClick="checkout.back(); return false;" class="back"><small>« </small>Back</a> <span id="shipping-method-please-wait" class="please-wait" style="display:none;"> <?php echo $this->Html->image('opc-ajax-loader.gif',['alt'=>'Loading next step...','title'=>'Loading next step...','class'=>'v-middle']); ?> Loading next step... </span> </div>
                </form>
              </div>
            </li>
            <li id="opc-payment" class="section">
              ...
              <div id="checkout-step-payment" class="step a-item" style="display:none;"> 
                ...
                <div class="buttons-set" id="payment-buttons-container">
                  ...
                  <a href="#" onClick="checkout.back(); return false;" class="back"><small>« </small>Back</a> <span class="please-wait" id="payment-please-wait" style="display:none;"> <?php echo $this->Html->image('opc-ajax-loader.gif',['alt'=>'Loading next step...','title'=>'Loading next step...','class'=>'v-middle']); ?> Loading next step... </span> </div>
