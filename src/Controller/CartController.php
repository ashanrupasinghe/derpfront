...
class CartController extends AppController {
	...
	public function sendToAll2($orderId, $trype, $suppliers, $delivery, $orderdata=null,$cart_id=null) {
		...
		// 
		$admin_mail_address="ashanrupasinghe11@gmail.com";
		...
		$admin_mail [$admin_mail_address] = $delivery_mail_string;
		$customer_mail [$customer_mail_address] = $delivery_mail_string;
		/*
		 * print_r($emails[4]);
		 * print_r($emails[3]);
	...
	/* 	print '<pre>';
		...
		$this->sendemail ( 'new', $admin_mail, 'admin' ); // delivery email
		$this->sendemail ( 'new', $customer_mail, 'cus' ); // delivery email
		// die();
	}
