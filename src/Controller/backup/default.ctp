        ...
        <div id="page">
            <header>
                ...
                <div id="header">
                    <div class="header-container container">
                        <div class="row">
                            <div class="logo" style="width: 75%;"> <a href="index.html" title="Direct2door.lk">
                                    <div><img src="/images/Direct-2-door-final.png" alt="Direct2door.lk Store" style="width: 200px;"></div>
                                </a> </div>
                                    ...
                                    <div class="mini-cart">
                                        ...
                                        <div class="fl-mini-cart-content" style="display: none;">
                                            ...
                                            <ul class="mini-products-list" id="cart-sidebar">
                                                <li class="item first">
                                                    <div class="item-inner"><a class="product-image" title="timi &amp; leslie Sophia Diaper Bag, Lemon Yellow/Shadow White" href="#l"><img alt="timi &amp; leslie Sophia Diaper Bag, Lemon Yellow/Shadow White" src="/products-images/product-img.jpg"></a>
                                                ...
                                                <li class="item last">
                                                    <div class="item-inner"><a class="product-image" title="JP Lizzy Satchel Designer Diaper Bag - Slate Citron" href="#"><img alt="JP Lizzy Satchel Designer Diaper Bag - Slate Citron" src="/products-images/product-img.jpg"></a>
                                                        <div class="product-details">
                                                            <div class="access"><a class="btn-remove1" title="Remove This Item" href="#">Remove</a> <a class="btn-edit" title="Edit item" href="#"><i class="icon-pencil"></i><span class="hidden">Edit item</span></a> </div>
                                                            <!--access-->
            ...
            <footer>
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-12 col-lg-4">
                                <div class="co-info">
                                    ...
                                    <address>
                                        <div><em class="icon-location-arrow"></em> <span> Colombo, Sri Lanka</span></div>
                                        <div> <em class="icon-mobile-phone"></em><span> 011 7 55 66 00</span></div>
                                        <div> <em class="icon-envelope"></em><span>info@direct2door.lk</span></div>
                                    </address>
                                    <div class="social">
                                        <ul class="link">
                ...
                <div class="footer-bottom">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12 coppyright">© 2017 Direct2door.lk. All Rights Reserved.</div>
