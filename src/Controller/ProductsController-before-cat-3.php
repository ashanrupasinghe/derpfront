    ...
    public function category($slug) {
        ...
        if ($slug != null) {
            ...
            if (sizeof($cat) > 0) {
                $return['category'] = $cat;
                $sub_categories=[];
                if ($cat ['parent_id'] == 0 || in_array($cat ['parent_id'], $cat_levels['second'])) { // parent
            ...
            public function getCategoryTree2() {
            			  ...
            			  if ($cat2_parent==$cat_id){
            			 	...
            			 	foreach ($third_level_categories as $cat3_id=>$cat3_parent){
            			 		if ($cat3_parent==$cat2_id){
            			 			$catArray[$cat_id][$cat2_id][$cat3_id]=$cat3_id;            			 			
            			 		}
            			 	}
            	...
            	return ['first'=>$first_level_categories, 'second'=>$second_level_categories, 'third'=>$third_level_categories,'full'=>$catArray];
            }
